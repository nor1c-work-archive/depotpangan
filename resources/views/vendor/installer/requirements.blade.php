        ...
        <ul class="list">
            ...
            @foreach($requirements['requirements'][$type] as $extention => $enabled)
                ...
                <li class="list__item {{ $enabled ? 'success' : 'error' }}">
                    ...
                    <br>
                    <small>Please Make sure your mupload max filesize is greater than {{$requirements['extensions_limit_array']['upload_max_filesize']}}MB <?=ini_get('upload_max_filesize')?></small>
                    @endif
                    @if($extention == 'post_max_size')
                    <br>
                    <small>Please Make sure your post max size is greater than {{$requirements['extensions_limit_array']['post_max_size']}}MB <?=ini_get('post_max_size')?></small>
                    @endif
