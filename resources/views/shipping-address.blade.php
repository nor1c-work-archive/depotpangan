            ...
            <form id="shippingAddressForm">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" data-toggle="modal" data-target="#mapModal" name="location" id="location" aria-describedby="addressHelp" placeholder="{{ trans('lables.shipping-address-latlong') }}">
                  <div class="invalid-feedback">
