    ...
    public function toArray($request)
    {
        ...
        if (\Request::route()->getName() == 'products.index') {
            ...
            return [
                ...
                'product_price_symbol' => !isset($currency->symbol_position) ? currencyFormat(($this->price * $this->exchange_rate)) : ($currency->symbol_position == 'right' ? currencyFormat(($this->price * $this->exchange_rate)) . ' ' . $currency->code : $currency->code . ' ' . currencyFormat(($this->price * $this->exchange_rate))),
                'currency' => $currency,
                'product_discount_price' => $this->discount_price * $this->exchange_rate,
                'product_discount_price_symbol' => !isset($currency->symbol_position) ? currencyFormat($this->discount_price * $this->exchange_rate) : ($currency->symbol_position == 'right' ? currencyFormat(($this->discount_price * $this->exchange_rate)) . ' ' . $currency->code : $currency->code . ' ' . currencyFormat(($this->discount_price * $this->exchange_rate))),
