...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:user-api', 'scopes:user']], function () {
    ...
    Route::resource('delivery_boy', 'API\Admin\DeliveryBoyController', ['names' => ['index' => 'admin.delivery_boy', 'store' => 'admin.delivery_boy', 'update' => 'admin.account.update', 'destroy' => 'admin.account.delete']])->except(['edit', 'create']);
