...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:user-api', 'scopes:user']], function () {
    ...
    Route::resource('delivery_boy', 'API\Admin\DeliveryBoyController', ['names' => ['index' => 'admin.delivery_boy', 'store' => 'admin.delivery_boy.store', 'update' => 'admin.delivery_boy.update', 'destroy' => 'admin.delivery_boy.delete']])->except(['edit', 'create']);
